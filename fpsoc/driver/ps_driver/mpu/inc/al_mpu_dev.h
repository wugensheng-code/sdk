...
#ifndef __AL_MPU_DEV_H_
#define __AL_MPU_DEV_H_
...
#define AL_MPU_ERR_ILLEGAL_PARAM            (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, AL_ERR_ILLEGAL_PARAM))
#define AL_MPU_ERR_INVALID_DEVICE_ID        (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, MPU_INVALID_DEVICE_ID))
#define AL_MPU_ERROR_REGION_ENABLED         (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, MPU_REGION_ENABLED))
#define AL_MPU_ERROR_REGION_NUMBER          (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, MPU_INVALID_REGION_NUMBER))
#define AL_MPU_ERROR_NO_AVAILABLE_REGION    (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, MPU_NO_AVAILABLE_REGION))
#define AL_MPU_ERROR_INITIALIZE_FAILED      (AL_DEF_ERR(AL_MPU, AL_LOG_LEVEL_ERROR, MPU_INITIALIZE_FAILED))
