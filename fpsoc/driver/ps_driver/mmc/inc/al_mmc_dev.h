...
typedef enum
{
    MMC_ERR_INVALID_DEVID            = 0x100,    /* receive message with error*/
    MMC_ERR_INVALID_CARD,
...
#define AL_MMC_ERR_SET_BUS_WIDTH        AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_SET_BUS_WIDTH)
...
typedef enum
{
    ...
    AL_MMC_FREQ_KHZ_20000   = 20000,
    AL_MMC_FREQ_KHZ_25000   = 25000,
    AL_MMC_FREQ_KHZ_26000   = 26000,
    AL_MMC_FREQ_KHZ_30000   = 30000,
