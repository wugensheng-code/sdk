...
#define AL_MMC_ERR_INVALID_CHNID        AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_INVALID_CHNID)
#define AL_MMC_ERR_ILLEGAL_PARAM        AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_ILLEGAL_PARAM)
#define AL_MMC_ERR_EXIST                AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_EXIST)
#define AL_MMC_ERR_UNEXIST              AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_UNEXIST)
#define AL_MMC_ERR_NULL_PTR             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_NULL_PTR)
#define AL_MMC_ERR_NOT_CONFIG           AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, AL_ERR_NOT_CONFIG)
...
#define AL_MMC_ERR_CMD_TOUT             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CMD_TOUT)
#define AL_MMC_ERR_CMD_CRC              AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CMD_CRC)
#define AL_MMC_ERR_CMD_END_BIT          AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CMD_END_BIT)
#define AL_MMC_ERR_CMD_IDX              AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CMD_IDX)
#define AL_MMC_ERR_DATA_TOUT            AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_DATA_TOUT)
#define AL_MMC_ERR_DATA_CRC             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_DATA_CRC)
#define AL_MMC_ERR_DATA_END_BIT         AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_DATA_END_BIT)
#define AL_MMC_ERR_CUR_LMT              AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CUR_LMT)
#define AL_MMC_ERR_AUTO_CMD             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_AUTO_CMD)
#define AL_MMC_ERR_ADMA                 AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_ADMA)
#define AL_MMC_ERR_TUNING               AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_TUNING)
#define AL_MMC_ERR_RESP                 AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_RESP)
#define AL_MMC_ERR_BOOT_ACK             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_BOOT_ACK)
#define AL_MMC_ERR_RST_LINE_TIMEOUT     AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_RST_LINE_TIMEOUT)
#define AL_MMC_ERR_CARD_NOT_INSERTED    AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_CARD_NOT_INSERTED)
#define AL_MMC_ERR_STATE_NOT_READY      AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_STATE_NOT_READY)
#define AL_MMC_ERR_TRANS_BUSY           AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_TRANS_BUSY)
#define AL_MMC_ERR_HOST_RST             AL_DEF_ERR(AL_MMC, AL_LOG_LEVEL_ERROR, MMC_ERR_HOST_RST)
