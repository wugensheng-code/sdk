...
static AL_DMACAHB_ChInitStruct AlDmacAhb_ChDefInitConfig = {
    ...
    .HandShaking.DstHsSel   = AL_DMACAHB_HAND_SHAKING_SOFTWARE,
    .HandShaking.SrcHsPol   = AL_DMACAHB_HS_POL_ACTIVE_HI,
    .HandShaking.DstHsPol   = AL_DMACAHB_HS_POL_ACTIVE_HI,
                          ...
                          AL_DMACAHB_ChInitStruct *InitConfig)
{
    ...
    if (Channel->Dmac->State.ChEn & AlDmacAhb_ChParam[Channel->Config.Id].ChMask) {
#ifdef DMACAHB_DEBUG
        AL_LOG(AL_ERR_LEVEL_ERROR, "dmacahb channel%d has been enabled\r\n", Channel->Config.Id);
#endif
        return AL_DMACAHB_ERR_ENABLED_CHANNEL;
    }
...
AL_VOID AlDmacAhb_Dev_IntrHandler(AL_VOID *Instance)
{
    ...
    if (AL_DMACAHB_ERR_INTR(IntrStatus)) {
