...
AL_U32 AlSmc_Hal_ReadPage(AL_SMC_HalStruct *Handle, AL_U64 Addr, AL_U8 *Data, AL_U32 Size, AL_U32 Timeout);
AL_U32 AlSmc_Hal_WritePage(AL_SMC_HalStruct *Handle, AL_U64 Addr, AL_U8 *Data, AL_U32 Size, AL_U32 Timeout);
