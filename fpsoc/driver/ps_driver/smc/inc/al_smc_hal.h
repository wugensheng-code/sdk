...
#ifndef __AL_SMC_HAL_H_
#define __AL_SMC_HAL_H_
...
AL_U32 AlSmc_Hal_ReadPage(AL_SMC_HalStruct *Handle, AL_U64 Addr, AL_U8 *Data, AL_U32 Size);
AL_U32 AlSmc_Hal_WritePage(AL_SMC_HalStruct *Handle, AL_U64 Addr, AL_U8 *Data, AL_U32 Size);
...
AL_U32 AlSmc_Hal_EraseBlock(AL_SMC_HalStruct *Handle, AL_U32 Addr);
