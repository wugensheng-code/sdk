...
#define AL_SPI_EVENTS_TO_ERRS(Event) (AL_DEF_ERR(AL_SPI, AL_LOG_LEVEL_ERROR, (Event << AL_ERR_MAX)))
...
typedef enum
{
    ...
    AL_SPI_IOCTL_SET_MODE,
    AL_SPI_IOCTL_GET_MODE,
    AL_SPI_IOCTL_SET_PROT_FORMAT,
    AL_SPI_IOCTL_GET_PROT_FORMAT,
    AL_SPI_IOCTL_SET_CPOLANDCPHA,
    AL_SPI_IOCTL_GET_CPOLANDCPHA,
    AL_SPI_IOCTL_SET_CLOCK_DIV,
    AL_SPI_IOCTL_GET_CLOCK_DIV,
    AL_SPI_IOCTL_SET_SLV_TOGGLE,
