...
{
    return AlGpio_ll_IntrGetEnable(Gpio->Configs.BaseAddr + Bank * GPIO_REG_OFFSET);
}
...
{
    return AlGpio_ll_IntrGetEnableMask(Gpio->Configs.BaseAddr + Bank * GPIO_REG_OFFSET);
}
...
AL_VOID AlGpio_Dev_DebounceEnablePin(AL_GPIO_DevStruct *Gpio, AL_U32 Pin)
{
    ...
    AlGpio_ll_DebounceEnable(Gpio->Configs.BaseAddr + Bank * GPIO_REG_OFFSET, DebounceReg);
}
...
AL_VOID AlGpio_Dev_DebounceClrEnablePin(AL_GPIO_DevStruct *Gpio, AL_U32 Pin)
{
    ...
    AlGpio_ll_DebounceClrEnable(Gpio->Configs.BaseAddr + Bank * GPIO_REG_OFFSET, DebounceClrReg);
}
