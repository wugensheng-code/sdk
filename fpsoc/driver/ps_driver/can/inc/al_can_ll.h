...
#ifndef __AL_CAN_LL_H_
#define __AL_CAN_LL_H_
...
// {
//     return (AL_BOOL)AL_REG32_GET_BIT(CAN_TOP_CFG_CTRL_ADDR, ((BaseAddr == CAN0__BASE_ADDR) ?
//                             CAN_TOP_CFG_CTRL_ADDR_CAN0_FD_ENABLE_SHIFT : CAN_TOP_CFG_CTRL_ADDR_CAN1_FD_ENABLE_SHIFT));
// }

static inline AL_VOID AlCan_ll_SetFdEnabled(AL_REG BaseAddr, AL_BOOL IsEnabled)
{
    AL_REG32_SET_BIT(CAN_TOP_CFG_CTRL_ADDR, ((BaseAddr == CAN0__BASE_ADDR) ? CAN_TOP_CFG_CTRL_ADDR_CAN0_FD_ENABLE_SHIFT :
            CAN_TOP_CFG_CTRL_ADDR_CAN1_FD_ENABLE_SHIFT), IsEnabled);
}

// static inline AL_BOOL AlCan_ll_IsDmaEnabled(AL_REG BaseAddr)
// {
//     return (AL_BOOL)AL_REG32_GET_BIT(CAN_TOP_CFG_CTRL_ADDR, ((BaseAddr == CAN0__BASE_ADDR) ?
//                             CAN_TOP_CFG_CTRL_ADDR_CAN0_DMA_ENABLE_SHIFT : CAN_TOP_CFG_CTRL_ADDR_CAN1_DMA_ENABLE_SHIFT));
// }

static inline AL_VOID AlCan_ll_SetDmaEnabled(AL_REG BaseAddr, AL_BOOL IsEnabled)
{
    AL_REG32_SET_BIT(CAN_TOP_CFG_CTRL_ADDR, ((BaseAddr == CAN0__BASE_ADDR) ? CAN_TOP_CFG_CTRL_ADDR_CAN0_DMA_ENABLE_SHIFT :
            CAN_TOP_CFG_CTRL_ADDR_CAN1_DMA_ENABLE_SHIFT), IsEnabled);
}
