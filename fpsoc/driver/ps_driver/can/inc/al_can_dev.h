...
#define AL_CAN_ERR_INVALID_DEVID        AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_INVALID_DEVID)
#define AL_CAN_ERR_INVALID_CHNID        AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_INVALID_CHNID)
#define AL_CAN_ERR_ILLEGAL_PARAM        AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_ILLEGAL_PARAM)
#define AL_CAN_ERR_EXIST                AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_EXIST)
#define AL_CAN_ERR_UNEXIST              AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_UNEXIST)
#define AL_CAN_ERR_NULL_PTR             AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_NULL_PTR)
#define AL_CAN_ERR_NOT_CONFIG           AL_DEF_ERR(AL_CAN, AL_LOG_LEVEL_ERROR, AL_ERR_NOT_CONFIG)
