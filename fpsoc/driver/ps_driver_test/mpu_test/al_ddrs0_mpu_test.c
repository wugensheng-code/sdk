...
static AL_MPU_HalStruct *Ddrs0Handle;

#define DDRS0_MPU_DEVICE_ID     0

int main()
{
    AL_LOG(AL_LOG_LEVEL_INFO, "DDRS0 MPU config example\r\n");
    ...
    RegionConfig.StartAddr = 0x10000;
    ...
    RetValue = AlMpu_Hal_ConfigInit(DDRS0_MPU_DEVICE_ID, &Ddrs0Handle, AL_NULL, &RegionConfig, 1);
    if (RetValue != AL_OK) {
    ...
    *((volatile int *)(0x10000+0x8)) = 0x12345678;
