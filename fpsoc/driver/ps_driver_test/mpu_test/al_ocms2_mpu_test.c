...
static AL_MPU_HalStruct *Ocms2Handle;

#define OCMS2_MPU_DEVICE_ID     5

int main()
{
    AL_LOG(AL_LOG_LEVEL_INFO, "OCMS2 MPU config example\r\n");
    ...
    RegionConfig.StartAddr = 0x61032000;
    ...
    RetValue = AlMpu_Hal_ConfigInit(OCMS2_MPU_DEVICE_ID, &Ocms2Handle, AL_NULL, &RegionConfig, 1);
    if (RetValue != AL_OK) {
    ...
    *((volatile int *)(0x61032000+0x8)) = 0x12345678;
