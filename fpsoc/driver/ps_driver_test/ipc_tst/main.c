...
AL_S32 main(AL_VOID)
{
    ...
    AL_S32 Ret = AL_OK;
    AL_U32 Value = 0xffee;
    AL_Ipc_MailBox_HalStruct *Mailbox_Handle;
    ...
    AL_U32 Key = 0;
    AL_U32 Same_Key = 0;
    AL_Ipc_SpinLock_HalStruct *Spinlock_Handle;
    ...
    for (int i = 0; i < 4; i++) 
    {
        ...
        if (!Same_Key) {
            ...
            AL_LOG(AL_LOG_LEVEL_INFO, "Successfully obtained the same spin lock, testing failed")
        }
