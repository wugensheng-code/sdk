...
uint32_t *OutputDataBuffPcap = (uint32_t *)(CSU_PCAP_WR_STREAM);
//
...
uint32_t HashDataSize = (HASH_LENGTH);

uint32_t UserSm4Key[] = {0xB82BB78D, 0x06928435, 0x6FFC32A6, 0x054A4C73};
uint32_t UserSm4IV[] = {0xC624E1DB, 0x141E678E, 0x91346E89, 0x1378FD4E};

uint32_t UserAesKey[] = {0xB82BB78D, 0x06928435, 0x6FFC32A6, 0x054A4C73, \
                        0xBAF6AF50, 0xE5045340, 0x66A47271, 0xE72FF6A6};
uint32_t UserAesIV[] = {0xC624E1DB, 0x141E678E, 0x91346E89, 0x1378FD4E};

uint32_t EccPpk[] = {0x246394d6, 0x965bd1d9, 0x6cc6637a, 0x2abe94b1, \
...
uint32_t EccSpk[] = {0x353b1782, 0xd84265a7, 0x6284d0d1, 0xe7eb75b8, \
...
uint32_t EccSpkHash[] = {0x27d91395, 0xa56c703d, 0x3e2d01b6, 0xb0f14b22, \
                        0x8c1f761a, 0xb7a58e7e, 0x2117f2aa, 0x675894ec};
uint32_t EccSpkSig[] = {0xe3c97a36, 0x02d621e1, 0x27537ba6, 0x0e329852, \
...
uint32_t Sm2Ppk[] = {0xf9604902, 0x6cc22fa7, 0x67143dfa, 0x46d1bfed, \
...
uint32_t Sm2Spk[] = {0x856d0b0c, 0xba96854c, 0x47702880, 0x2c7d9e2a, \
...
uint32_t Sm2SpkHash[] = {0xb0fc8ccc, 0x1345a52c, 0xa6cda231, 0xf089bb25, \
                        0xba071863, 0x9afe91fe, 0xd9f12c1a, 0xafc47d2c};
uint32_t Sm2SpkSig[] = {0xa5d3b779, 0x7272277f, 0x3b6b68b6, 0x170ed521, \
...
uint32_t EncCbcAesDataBuff[] = {0x486AEB42, 0xD121E0FB, 0xEE7681E8, 0xC84FA271, \
                                0x5947CC5C, 0x81E38E48, 0x09B6A262, 0xB3AD2AEB};
uint32_t EncCbcSm4DataBuff[] = {0x01B0BC04, 0x1EC5FABE, 0x6AE45260, 0xF5950598, \
                                0x176B25D8, 0xF88788BE, 0xE6179D17, 0x659F4368};

uint32_t PerformaceImageAddr[] = {IMAGE_1K_ADDR, IMAGE_4K_ADDR, \
                                    IMAGE_8K_ADDR, IMAGE_16K_ADDR, \
                                    IMAGE_32K_ADDR, IMAGE_64K_ADDR, \
                                    IMAGE_128K_ADDR};
uint32_t PerformaceImageSize[] = {INPUT_DATA_SIZE_1K, INPUT_DATA_SIZE_4K, \
                                    INPUT_DATA_SIZE_8K, INPUT_DATA_SIZE_16K, \
                                    INPUT_DATA_SIZE_32K, INPUT_DATA_SIZE_64K, \
                                    INPUT_DATA_SIZE_128K};

uint32_t Ida[] = {0x486AEB42, 0xD121E0FB, 0xEE7681E8, 0xC84FA271, \
                0x5947CC5C, 0x81E38E48, 0x09B6A262, 0xB3AD2AEB};
...
const TestCfgBothInc_t TestCfgSrcIncData[] = \
            {{.CryptMethod=AL_CIPHER_OPS_CRYPT_AES256, .HashMode=AL_CIPHER_OPS_HASH_SHA256, \
            .DmaSrcAddr=TBM_INPUT_DATA_ADDR, .DmaDstAddr=CSU_PCAP_WR_STREAM, .HashOutAddr=HASH_BUF_ADDR, \
            ...
            .EcbCbc=AL_CIPHER_CRYPT_MODE_ECB, .EncDec=AL_CIPHER_CRYPT_DEC},\
            {.CryptMethod=AL_CIPHER_OPS_CRYPT_AES256, .HashMode=AL_CIPHER_OPS_HASH_NONE, \
            .DmaSrcAddr=TBM_INPUT_DATA_ADDR, .DmaDstAddr=CSU_PCAP_WR_STREAM, .HashOutAddr=(AL_U32)(AL_UINTPTR)AL_NULL, \
