...
#ifndef __AL_DMACAHB_TEST_CONFIG_H_
#define __AL_DMACAHB_TEST_CONFIG_H_
...
static AL_DMACAHB_ChInitStruct ChSingleModeEg1 = {
    ...
    .SgrDsr.SrcGatherCount      = 1,
    .SgrDsr.SrcGatherInterval   = 1,
    .SgrDsr.IsDstScatterEn      = AL_FALSE,
    .SgrDsr.DstScatterCount     = 1,
    .SgrDsr.DstScatterInterval  = 1,
