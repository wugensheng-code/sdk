...
AL_U32 AlAxiQspi_Polled_3Byte_example()
{
...
static AL_U32 AlAxiQspi_FlashRead(AlAxiQspi_HalStruct *AlAxiQspiHandle, AL_U8 *Data, AL_U32 Addr, AL_U32 Size)
{
    ...
    TempArray[2] = (Addr >> 8) & 0xFF;
    TempArray[3] = Addr & 0xFF;
    return AlAxiQspi_Hal_TransferDataPolledBlock(AlAxiQspiHandle, TempArray, 4, Data, Size, TIMEOUT_FOR_TEST);
}
...
int main(void) {
    RUN_TEST(AlAxiQspi_Polled_3Byte_example);
