...
typedef enum IRQn {
    ...
    FirstDeviceSpecificInterrupt_IRQn    = 19,    /*!< First Device Specific Interrupt */
	    ...
	    Reserved31_IRQn            =   31,              /*!<  Internal reserved */
	    Reserved32_IRQn            =   32,              /*!<  Internal reserved */
	    Reserved33_IRQn            =   33,              /*!<  Internal reserved */
	    Reserved34_IRQn            =   34,              /*!<  Internal reserved */
	    Reserved35_IRQn           =    35,              /*!<  Internal reserved */
	    Reserved36_IRQn           =    36,              /*!<  Internal reserved */
	    Reserved37_IRQn           =    37,              /*!<  Internal reserved */
	    Reserved38_IRQn           =    38,              /*!<  Internal reserved */
	    Reserved39_IRQn           =    39,              /*!<  Internal reserved */
	    Reserved40_IRQn           =    40,              /*!<  Internal reserved */
	    Reserved41_IRQn           =    41,              /*!<  Internal reserved */
		Reserved42_IRQn            =   42,              /*!<  Internal reserved */
	    Reserved43_IRQn            =   43,              /*!<  Internal reserved */
        Reserved44_IRQn            =   44,              /*!<  Internal reserved */
        Reserved45_IRQn            =   45,              /*!<  Internal reserved */
	    Reserved46_IRQn           =    46,              /*!<  Internal reserved */
        Reserved47_IRQn           =    47,              /*!<  Internal reserved */
	    Reserved48_IRQn           =    48,              /*!<  Internal reserved */
        Reserved49_IRQn           =    49,              /*!<  Internal reserved */
	    Reserved50_IRQn           =    50,              /*!<  Internal reserved */
	    Reserved51_IRQn           =    51,              /*!<  Internal reserved */
	    Reserved52_IRQn           =    52,              /*!<  Internal reserved */
	    Reserved53_IRQn            =   53,              /*!<  Internal reserved */
	    Reserved54_IRQn            =   54,              /*!<  Internal reserved */
	    Reserved55_IRQn            =   55,              /*!<  Internal reserved */
	    Reserved56_IRQn            =   56,              /*!<  Internal reserved */
	    Reserved57_IRQn           =    57,              /*!<  Internal reserved */
		XEC0_IRQn                = 58,                /*!gbe0*/
