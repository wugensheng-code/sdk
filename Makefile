...
.PHONY: __help
__help:
	@echo "Help about Build/Run/Debug an Nuclei SDK apps"
	@echo "make [PROGRAM=/path/to/app]  help        Show Build System Help Message"
	@echo "make cleanall                            Clean all the appss found in apps and test folder"
	@echo "Example:"
	@echo "make PROGRAM=apps/baremetal/helloworld all"
...
PROGS_TO_SEARCH := apps/* apps/*/* apps/*/*/* apps/*/*/*/* SoC/*/*/*/
