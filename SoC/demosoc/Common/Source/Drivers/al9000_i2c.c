...
/*!
    ...
    \retval
*/
void i2c_setSclCount(I2C_TypeDef *i2c,enum i2c_speed_mode
...
/*!
    ...
    \retval
*/
void i2c_setSpeedMode(I2C_TypeDef *i2c,enum i2c_speed_mode mode)
{
...
/*!
    ...
    \retval
*/
void i2c_setMasterAddressMode(I2C_TypeDef *i2c,enum i2c_address_mode mode)
{
...
/*!
    ...
    \retval
*/
void i2c_setSlaveAddressMode(I2C_TypeDef *i2c,enum i2c_address_mode mode)
{
...
/*!
    ...
    \retval
*/
void i2c_enableMaster(I2C_TypeDef *i2c)
{
...
/*!
    ...
    \retval
*/
void i2c_enableSlave(I2C_TypeDef *i2c)
{
...
/*!
    ...
    \retval
*/
void i2c_setTargetAddress(I2C_TypeDef *i2c, uint16_t address)
{
...
/*!
    ...
    \retval
*/
void i2c_setSlaveAddress(I2C_TypeDef *i2c, uint16_t address)
{
...
/*!
    ...
    \retval
*/
void i2c_write(I2C_TypeDef *i2c, enum i2c_cmd_type type, uint8_t data)
{
    if(type == normal)
    {
...
/*!
    ...
    \retval
*/
BOOL i2c_isRxFifoEmpty(I2C_TypeDef *i2c)
{
	BOOL retval;
...
/*!
    ...
    \retval
*/
void i2c_issueRead(I2C_TypeDef *i2c, enum i2c_cmd_type type)
{
    if(type == normal)
    {
...
/*!
    ...
    \retval
*/
void i2c_irq_mask(I2C_TypeDef *i2c,uint32_t mask)
{
...
/*!
    ...
    \retval
*/
void i2c_txThr(I2C_TypeDef *i2c, uint8_t waterlevel)
{
...
/*!
    ...
    \retval
*/
void i2c_rxThr(I2C_TypeDef *i2c, uint8_t waterlevel)
{
...
/*!
    ...
    \retval
*/
void i2c_sdaHold_rx(I2C_TypeDef *i2c, uint8_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_sdaHold_tx(I2C_TypeDef *i2c, uint16_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_sdaSetup(I2C_TypeDef *i2c, uint8_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_spklen(I2C_TypeDef *i2c, uint8_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_irq_clrAll(I2C_TypeDef *i2c)
{
	uint8_t retval;
...
/*!
    ...
    \retval
*/
uint32_t i2c_irq_stat(I2C_TypeDef *i2c)
{
...
void i2c_clock_setup(I2C_TypeDef *i2c, unsigned ic_clk)
{
    ...
    i2c_setSclCount(i2c, I2c_speed_standard, I2c_scl_high, ss_scl_high);
    i2c_setSclCount(i2c, I2c_speed_standard, I2c_scl_low, ss_scl_low);
    i2c_setSclCount(i2c, I2c_speed_fast, I2c_scl_high, fs_scl_high);
    i2c_setSclCount(i2c, I2c_speed_fast, I2c_scl_low, fs_scl_low);
    i2c_setSclCount(i2c, I2c_speed_high, I2c_scl_high, hs_scl_high);
    i2c_setSclCount(i2c, I2c_speed_high, I2c_scl_low, hs_scl_low);
}
...
/*!
    ...
    \retval
*/
void i2c_RxFull_SclHold_cfg(I2C_TypeDef *i2c, uint8_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_busClr_cfg(I2C_TypeDef *i2c, uint8_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_sclTimeout_cfg(I2C_TypeDef *i2c, uint32_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_sdaTimeout_cfg(I2C_TypeDef *i2c, uint32_t value)
{
...
/*!
    ...
    \retval
*/
void i2c_sdaStuck_recvEn_cfg(I2C_TypeDef *i2c, uint8_t value)
{
