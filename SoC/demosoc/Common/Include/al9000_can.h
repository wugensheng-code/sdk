...
/*
 CAN_Error_Code_constants(0xb0)
*/
#define CAN_ErrorCode_NoErr           	((uint8_t)0x00) /*!< No Error */ 
#define	CAN_ErrorCode_BitErr      		((uint8_t)0x10) /*!< Stuff Error */ 
#define	CAN_ErrorCode_FormErr        	((uint8_t)0x20) /*!< Form Error */ 
#define	CAN_ErrorCode_StuffErr          ((uint8_t)0x30) /*!< Acknowledgment Error */ 
#define	CAN_ErrorCode_AckErr 			((uint8_t)0x40) /*!< Bit Recessive Error */ 
#define	CAN_ErrorCode_CrcErr  			((uint8_t)0x50) /*!< Bit Dominant Error */ 
#define	CAN_ErrorCode_otherErr          ((uint8_t)0x60) /*!< CRC Error  */ 
#define	CAN_ErrorCode_OtherErr  		((uint8_t)0x70) /*!< Software Set Error */ 
...
/*
Warning Limits Register LIMIT (0xa7)具体数据看具体的参数来进行定义
*/
...
/*
Acceptance Filter Enable ACF_EN_0 (0xb6)
*/
#define CAN_ACF_EN_0_Filter0			(uint8_t 0x00)
#define CAN_ACF_EN_0_Filter1			(uint8_t 0x01)
#define CAN_ACF_EN_0_Filter2			(uint8_t 0x02)
#define CAN_ACF_EN_0_Filter3			(uint8_t 0x03)
#define CAN_ACF_EN_0_Filter4			(uint8_t 0x04)
#define CAN_ACF_EN_0_Filter5			(uint8_t 0x05)
#define CAN_ACF_EN_0_Filter6			(uint8_t 0x06)
#define CAN_ACF_EN_0_Filter7			(uint8_t 0x07)

/*
Acceptance Filter Enable ACF_EN_1 (0xb7)
*/
#define CAN_ACF_EN_1_Filter0			(uint8_t 0x00)
#define CAN_ACF_EN_1_Filter1			(uint8_t 0x01)
#define CAN_ACF_EN_1_Filter2			(uint8_t 0x02)
#define CAN_ACF_EN_1_Filter3			(uint8_t 0x03)
#define CAN_ACF_EN_1_Filter4			(uint8_t 0x04)
#define CAN_ACF_EN_1_Filter5			(uint8_t 0x05)
#define CAN_ACF_EN_1_Filter6			(uint8_t 0x06)
#define CAN_ACF_EN_1_Filter7			(uint8_t 0x07)
/*
Time Trigger Configuration TTCFG (0xbf)
*/
#define CAN_TTCFG_TTEN				((uint8_t)0x00)/*!< Time Trigger Enable   */
#define CAN_TTCFG_T_PRESC			((uint8_t)0x00)/*!< TTCAN Timer PRESCaler   */
#define CAN_TTCFG_TTIF				((uint8_t)0x03)/*!< Time Trigger Interrupt Flag   */
#define CAN_TTCFG_TTIE				((uint8_t)0x04)/*!< Time Trigger Interrupt Enable   */
#define CAN_TTCFG_TEIF				((uint8_t)0x05)/*!< Trigger Error Interrupt Flag   */
#define CAN_TTCFG_WTIF				((uint8_t)0x06)/*!< Watch Trigger Interrupt Flag   */
#define CAN_TTCFG_WTIE				((uint8_t)0x07)/*!< Watch Trigger Interrupt Enable   */
