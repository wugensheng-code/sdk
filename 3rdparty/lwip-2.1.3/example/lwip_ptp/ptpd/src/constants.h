...
#define DEFAULT_CALIBRATED_OFFSET_NS    7000000000 /* offset from master < 10us -> calibrated */
#define DEFAULT_UNCALIBRATED_OFFSET_NS  9000000000 /* offset from master > 1000us -> uncalibrated */
