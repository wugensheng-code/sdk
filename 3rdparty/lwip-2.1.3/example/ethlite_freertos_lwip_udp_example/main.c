...
int main(void)
{
    ...
    printf("EthLite FreeRtos lwip udp echo example>>>\r\n");

    tcpip_init(NULL, NULL);

    ethlite_netif_config();

    udp_handle = sys_thread_new("TCP_udp", udpserv, NULL,
                                 TCP_SERVER_UDP_THREAD_STACK_SIZE, TCP_SERVER_UDP_THREAD_PRIO);
