...
printf("==>0 USBD_IRQHandler \r\n");
    if ((USB_OTG_GLB->GINTSTS & 0x1U) == USB_OTG_MODE_DEVICE) {
        ...
        if (gint_status & USB_OTG_GINTSTS_RXFLVL) {printf("==>1 USBD_IRQHandler \r\n");
...
#endif
        if (gint_status & USB_OTG_GINTSTS_OEPINT) {printf("==>2 USBD_IRQHandler \r\n");
            ep_idx = 0;
        ...
        if (gint_status & USB_OTG_GINTSTS_IEPINT) {printf("==>3 USBD_IRQHandler \r\n");
            ep_idx = 0U;
        ...
        if (gint_status & USB_OTG_GINTSTS_USBRST) {printf("==>4 USBD_IRQHandler \r\n");
        ...
        if (gint_status & USB_OTG_GINTSTS_ENUMDNE) {printf("==>5 USBD_IRQHandler \r\n");
        ...
        if (gint_status & USB_OTG_GINTSTS_PXFR_INCOMPISOOUT) {printf("==>6 USBD_IRQHandler \r\n");
        ...
        if (gint_status & USB_OTG_GINTSTS_IISOIXFR) {printf("==>7 USBD_IRQHandler \r\n");
            daintmask = USB_OTG_DEV->DAINTMSK;
            daintmask >>= 16;
        ...
        if (gint_status & USB_OTG_GINTSTS_SOF) {printf("==>8 USBD_IRQHandler \r\n");
            USB_OTG_GLB->GINTSTS |= USB_OTG_GINTSTS_SOF;
        }
        if (gint_status & USB_OTG_GINTSTS_USBSUSP) {printf("==>9 USBD_IRQHandler \r\n");
            USB_OTG_GLB->GINTSTS |= USB_OTG_GINTSTS_USBSUSP;
        }
        if (gint_status & USB_OTG_GINTSTS_WKUINT) {printf("==>10 USBD_IRQHandler \r\n");
            USB_OTG_GLB->GINTSTS |= USB_OTG_GINTSTS_WKUINT;
        }
        if (gint_status & USB_OTG_GINTSTS_OTGINT) {printf("==>11 USBD_IRQHandler \r\n");
