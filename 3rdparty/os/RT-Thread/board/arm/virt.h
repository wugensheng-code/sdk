...
/* GICv3 */
#define GIC_PL500_DISTRIBUTOR_PPTR      GICD_BASE
#define GIC_PL500_REDISTRIBUTOR_PPTR    GICR_RD_BASE
#define GIC_PL500_CONTROLLER_PPTR       GICC_CTRL
