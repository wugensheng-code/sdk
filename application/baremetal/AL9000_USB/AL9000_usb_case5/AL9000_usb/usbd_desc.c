...
uint8_t *  USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  *length = USB_SIZ_STRING_SERIAL;
  //printf("     ==> 0 doepint.b.setup   USBD_USR_SerialStrDescriptor  0 \r\n");
  /* Update the serial number string descriptor with the data from the unique ID*/
  Get_SerialNum();
  //printf("     ==> 0 doepint.b.setup   USBD_USR_SerialStrDescriptor  1 \r\n");
...
static void Get_SerialNum(void)
{
 ...
 // printf("     ==> 0 doepint.b.setup   USBD_USR_SerialStrDescriptor start 0 \r\n");
#if 0
...
//hcx_add
  ...
  deviceserial2 = 0xffffffff;
  
  deviceserial0 += deviceserial2;
  //printf("     ==> 0 doepint.b.setup   USBD_USR_SerialStrDescriptor  Get_SerialNum deviceserial0: 0x%08lx \r\n", deviceserial0);
  if (deviceserial0 != 0)
  {//printf("     ==> 0 doepint.b.setup   IntToUnicode  \r\n");
