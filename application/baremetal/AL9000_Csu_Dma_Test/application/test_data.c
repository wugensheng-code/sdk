...
#ifdef DMA_MSG
unsigned int * ibuff = (unsigned int*)(MSG_RAM_BASEADDR + 64 + 0x200);
unsigned int * obuff = (unsigned int*)(MSG_RAM_BASEADDR + 64 + 0x400);
#endif
#ifdef DMA_ROM
unsigned int * ibuff = (unsigned int*)(ROM_BASEADDR );
unsigned int * obuff = (unsigned int*)(ROM_BASEADDR + 0x8000);
#endif
#ifdef DMA_RAM
unsigned int * ibuff = (unsigned int*)(RAM_BASEADDR );
unsigned int * obuff = (unsigned int*)(RAM_BASEADDR + 0x8000);
#endif
#ifdef DMA_PKU
unsigned int * ibuff = (unsigned int*)(PKU_BASEADDR );
unsigned int * obuff = (unsigned int*)(PKU_BASEADDR + 0x800);
#endif
#ifdef DMA_AES
unsigned int * ibuff = (unsigned int*)(AES_BASEADDR );
unsigned int * obuff = (unsigned int*)(AES_BASEADDR + 0x800);
#endif
#ifdef DMA_HASH
unsigned int * ibuff = (unsigned int*)(HASH_BASEADDR );
unsigned int * obuff = (unsigned int*)(HASH_BASEADDR + 0x800);
#endif
#ifdef DMA_SM4
unsigned int * ibuff = (unsigned int*)(SM4_BASEADDR );
unsigned int * obuff = (unsigned int*)(SM4_BASEADDR + 0x800);
#endif
#ifdef DMA_SOC
unsigned int * ibuff = (unsigned int*)(SOC_BASEADDR );
unsigned int * obuff = (unsigned int*)(SOC_BASEADDR + 0x80080000);
#endif
...
void AesDataInit(void)
{
    ...
    for (i = 0; i < DATA_BUFF_SIZE; i += 4) {
    	*(ibuff + i * 4)       = 0x11111111 * (i / 4);
    	*(ibuff + (i + 1) * 4) = 0x11111111 * (i / 4);
    	*(ibuff + (i + 2) * 4) = 0x11111111 * (i / 4);
    	*(ibuff + (i + 3) * 4) = 0x11111111 * (i / 4);
    }
