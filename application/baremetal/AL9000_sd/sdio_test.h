...
typedef struct
{
	uint32_t REG_OFFSET_ADDR_1 : 16;
	uint32_t RESERVED_15_12 : 4;
	uint32_t REG_OFFSET_ADDR_0 : 12;
}P_VENDOR2_SPECIFIC_AREA__P_VENDOR_SPECIFIC_AREA;


typedef struct
{
	uint32_t INTR_SLOT : 8;
	uint32_t RESERVED_15_8 : 8;
	uint32_t SPEC_VERSION_NUM : 8;
	uint32_t VENDOR_VERSION_NUM : 8;
}HOST_CNTRL_VERS_R__SLOT_INTR_STATUS_R;
...
typedef struct
{
	uint32_t CARD_IS_EMMC : 1;
	uint32_t DISABLE_DATA_CRC_CHK : 1;
	uint32_t EMMC_RST_N : 1;
	uint32_t EMMC_RST_N_OE : 1;
	uint32_t RSVD_4_15 : 12;
	uint32_t MAN_BOOT_EN : 1;
	uint32_t RSVD_6_1 : 6;
	uint32_t VALIDATE_BOOT : 1;
	uint32_t BOOT_ACK_ENABLE : 1;
	uint32_t RSVD_27_25 : 3;
	uint32_t BOOT_TOUT_CNT : 4;
