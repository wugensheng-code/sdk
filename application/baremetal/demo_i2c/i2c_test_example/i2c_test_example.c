...
*/
int i2c_master_tx(I2C_TypeDef *master,I2C_TypeDef *slave,enum i2c_speed_mode speed_mode,enum i2c_address_mode address_mode)
{
	int i;
	uint8_t datum;
	...
	AlI2c_SetSpeedMode(master, speed_mode); // 100Kb/s
	AlI2c_SetMasterAddressMode(master, address_mode); // 7-bit
...
//	AlI2c_Clock_Setup(slave, I2C_CLOCK);
	AlI2c_SetSpeedMode(slave, speed_mode); // 100Kb/s
	AlI2c_SetSlaveAddressMode(slave, address_mode); // 7-bit
...
*/
int i2c_master_rx(I2C_TypeDef *master,I2C_TypeDef *slave,enum i2c_speed_mode speed_mode,enum i2c_address_mode address_mode)
{
	int i;
	uint8_t amount0 =15;
	uint32_t rdata0_0;	//
	...
	AlI2c_ClockSetup(master, I2C_CLOCK); // scl setup
	AlI2c_SetSpeedMode(master, speed_mode); // 100Kb/s
	AlI2c_SetMasterAddressMode(master, address_mode); // 10-bit
	AlI2c_EnableMaster(master); //master
