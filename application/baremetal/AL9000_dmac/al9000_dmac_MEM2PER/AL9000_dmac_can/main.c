...
int main(void){
	...
	set_reset_mode(AL9000_CAN1);
    	...
    	//Can_Send_Msg(AL9000_CAN0,tx_buf2,XMIT_PTB_MODE,data_length_12,0x11);
    	//Can_Send_Msg(AL9000_CAN0,tx_buf2,XMIT_PTB_MODE,data_length_48,0x12);
    	...
    	//Can_Send_Msg(AL9000_CAN0,tx_buf2,XMIT_PTB_MODE,data_length_64,0x13);
