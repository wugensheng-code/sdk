...
int main(void){
   ...
   printf("test start\r\n");
	...
	qspi_dma_Init(AL9000_DMAC_channel_0,tx,40,10,Dmac_transfer_row1,64);
	dwc_ssi_enable(QSPI0);
	...
	qspi_dma_Init(AL9000_DMAC_channel_0,tx,64,10,Dmac_transfer_row1,64);
	dwc_ssi_enable(QSPI0);
...
/*FLASH_X1_DFS_8         read data*/
	...
	qspi_dma_Init(AL9000_DMAC_channel_1,rx,32,10,Dmac_transfer_row1,32);
	/*en ssi*/
	dwc_ssi_enable(QSPI0);
...
//	qspi_sste_dis(QSPI0);
	...
	qspi_dma_Init(AL9000_DMAC_channel_0,rx,64,0,Dmac_transfer_row1,64);
	/*en ssi*/
	dwc_ssi_enable(QSPI0);
...
//	qspi_sste_dis(QSPI0);
	...
	//-----------------------------------------------------------
	/*en ssi*/
	qspi_dma_Init(AL9000_DMAC_channel_0,rx,32,10,Dmac_transfer_row1,32);
	dwc_ssi_enable(QSPI0);
...
//	qspi_sste_dis(QSPI0);
	...
	/*en ssi*/
	qspi_dma_Init(AL9000_DMAC_channel_0,tx,32,10,Dmac_transfer_row1,64);
	dwc_ssi_enable(QSPI0);
...
//	qspi_txftl_tft(QSPI0, 0); // default
	...
	//-----------------------------------------------------------
	/*en ssi*/
	qspi_dma_Init(AL9000_DMAC_channel_6,rx,32,10,Dmac_transfer_row1,32);
	dwc_ssi_enable(QSPI0);
