<<<<<<< HEAD:solutions/demo/fsbl/ddr/al9000_new_func.c
/*
...
{
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + pr0_cfg3, U_byte0_se_mc1_lb_en_offset, U_byte0_se_mc1_lb_en_mask, 1);
    ...
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + pr49_cfg3, U_byte3_se_mc1_lb_en_offset, U_byte3_se_mc1_lb_en_mask, 1);

    //BANK0
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr0_cfg3, U_byte0_se_mc1_lb_en_offset, U_byte0_se_mc1_lb_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr1to4_cfg11, U_byte0_quad1_mc1_lb_en_offset, U_byte0_quad1_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr5to8_cfg11, U_byte0_quad2_mc1_lb_en_offset, U_byte0_quad2_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr9to12_cfg11, U_byte0_quad3_mc1_lb_en_offset, U_byte0_quad3_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr13to16_cfg11, U_byte1_quad1_mc1_lb_en_offset, U_byte1_quad1_mc1_lb_en_mask, 0xf);


    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr17to20_cfg11, U_byte1_quad2_mc1_lb_en_offset, U_byte1_quad2_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr21to24_cfg11, U_byte1_quad3_mc1_lb_en_offset, U_byte1_quad3_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr25to28_cfg11, U_byte2_quad1_mc1_lb_en_offset, U_byte2_quad1_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr29to32_cfg11, U_byte2_quad2_mc1_lb_en_offset, U_byte2_quad2_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr33to36_cfg11, U_byte2_quad3_mc1_lb_en_offset, U_byte2_quad3_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr37to40_cfg11, U_byte3_quad1_mc1_lb_en_offset, U_byte3_quad1_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr41to44_cfg11, U_byte3_quad2_mc1_lb_en_offset, U_byte3_quad2_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr45to48_cfg11, U_byte3_quad3_mc1_lb_en_offset, U_byte3_quad3_mc1_lb_en_mask, 0xf);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + pr49_cfg3, U_byte3_se_mc1_lb_en_offset, U_byte3_se_mc1_lb_en_mask, 1);
...
int al9000_ddrppc_mtest_my(u8 bank, u16 row, u16 col, u8 byteNum)
{
    ...
    al9000_field_write(DDRC_ADDR_PPC + PGCR1, LBMODE_offset, LBMODE_mask, 1);
    ...
    for (patternType = 15; patternType <= 15; patternType++) {
        ...
        regData = al9000_field_set(DDRC_ADDR_PPC + BISTRR, BMODE_offset, BMODE_mask, 0, regData);
...
void external_loopback(void)
{
    ...
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + byte0_glue_cfg0, U_byte0_glue_mc1_rdqsn_gate_dis_en_offset, U_byte0_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + byte1_glue_cfg0, U_byte1_glue_mc1_rdqsn_gate_dis_en_offset, U_byte1_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + byte2_glue_cfg0, U_byte2_glue_mc1_rdqsn_gate_dis_en_offset, U_byte2_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK1_IOMC1 + byte3_glue_cfg0, U_byte3_glue_mc1_rdqsn_gate_dis_en_offset, U_byte3_glue_mc1_rdqsn_gate_dis_en_mask, 1);

    //set  *_mc1_rdqsn_gate_dis_en 1  BANK0
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + byte0_glue_cfg0, U_byte0_glue_mc1_rdqsn_gate_dis_en_offset, U_byte0_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + byte1_glue_cfg0, U_byte1_glue_mc1_rdqsn_gate_dis_en_offset, U_byte1_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + byte2_glue_cfg0, U_byte2_glue_mc1_rdqsn_gate_dis_en_offset, U_byte2_glue_mc1_rdqsn_gate_dis_en_mask, 1);
    al9000_field_write(DDRC_ADDR_BK0_IOMC1 + byte3_glue_cfg0, U_byte3_glue_mc1_rdqsn_gate_dis_en_offset, U_byte3_glue_mc1_rdqsn_gate_dis_en_mask, 1);

    //set oe_md = 2
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x20, 0x11111111);

    //set oe_md = 2  BANK0
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x8000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x1c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x800 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x20, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x20, 0x11111111);

    //set te_md = 2 BANK0
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x8000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x8000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x28, 0x11111111);

    //set te_md = 2
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x24, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x28, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x28, 0x11111111);

    //set pdr_md = 2 BANK0
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x8000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x8000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x9000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xa000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xb000 + 0x30, 0x11111111);

    //set pdr_md = 2
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x2c, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xc000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xd000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xe000 + 0x30, 0x11111111);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0xf000 + 0x30, 0x11111111);

    //set LCDLR3 = 0 ��LCDL4 = 0
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x78c, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x790, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x88c, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x890, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x98c, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0x990, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0xa8c, 0x0);
    al9000_ddr_reg_write(&ftcHandle, 0xf8420000 + 0x2000 + 0xa90, 0x0);
...
void AC_swap_en()
{
    al9000_field_write(DDRC_ADDR_GPLL + BK0_T01_MATRIX_CTRL, BK0_IS_AC_offset, BK0_IS_AC_mask, 0x0);
}
...
void al9000_zq_overwrite_cfg_new()
{
   ...
   // u32 env_cfg_ddr_mode = 3;
    ...
    if (override_en == 1)
    {
        ...
        for (n = 0; n <= 1; n++)
        {
            ...
            for (i = 0; i <= 1; i++)
            {
                ...
                al9000_reg_update(DDRC_ADDR_BK0_VREF + ZQ0CR + 0x2000 * n + 0x04 * i, regData, regDataNew);
            ...
            al9000_field_write(DDRC_ADDR_BK0_VREF + ZQ0PR + 0x2000 * n, FORCE_ZCAL_VT_UPDATE_offset, FORCE_ZCAL_VT_UPDATE_mask, 1);
            al9000_field_write(DDRC_ADDR_BK0_VREF + ZQ1PR + 0x2000 * n, FORCE_ZCAL_VT_UPDATE_offset, FORCE_ZCAL_VT_UPDATE_mask, 1);
        }
    ...
    if (env_cfg_ddr_mode == DDR3)
    {
        al9000_field_write(DDRC_ADDR_BK1_IOMC1 + pr49_cfg3, U_byte3_se_mc1_vref_padin_en_offset, U_byte3_se_mc1_vref_padin_en_mask, 1);
        al9000_field_write(DDRC_ADDR_BK1_IOMC1 + brefhp_cfg2, U_bankref_hp_mc1_vref_ext_en_offset, U_bankref_hp_mc1_vref_ext_en_mask, 1);
...
void gate_train()
{
    ...
    {
        regData = al9000_reg_read(DDRC_ADDR_PPC + DTCR0);
        if (env_cfg_ddr_mode == DDR4) {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTWBDDM_offset, DTWBDDM_mask, (env_cfg_DM | env_cfg_WDBI), regData);
        }
        else {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTWBDDM_offset, DTWBDDM_mask, 1, regData);
        }
        if ((DRAM_READ_RANDOM_INSTEAD_X == 1) | (env_cfg_is_micron == 1)) {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTRDBITR_offset, DTRDBITR_mask, 0, regDataNew);
        }
        else if ((env_cfg_ddr_mode == DDR4) && (env_cfg_RDBI == 1)) {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTRDBITR_offset, DTRDBITR_mask, 1, regDataNew);
        }
        else {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTRDBITR_offset, DTRDBITR_mask, 2, regDataNew);
        }

        regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTBDC_offset, DTBDC_mask, 2, regDataNew);  //data training bit deskewe centerning enable

        //temp disable refresh during training
        if (EN_GRAIN_REFRESH == 1) {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, RFSHDT_offset, RFSHDT_mask, 8, regDataNew);//drefresh during training and bist, defalut is 8
        }
        else {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, RFSHDT_offset, RFSHDT_mask, 0, regDataNew);
        }

        regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTMPR_offset, DTMPR_mask, 1, regDataNew); //data training using MPR
        al9000_reg_update(DDRC_ADDR_PPC + DTCR0, regData, regDataNew);

        regData = al9000_reg_read(DDRC_ADDR_PPC + DTCR1);
        regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR1, RDPRMBL_TRN_offset, RDPRMBL_TRN_mask, 1, regData); //read Preamble Training enable
        al9000_reg_update(DDRC_ADDR_PPC + DTCR1, regData, regDataNew);

        regData = al9000_reg_read(DDRC_ADDR_PPC + DXCCR);
        regDataNew = al9000_field_set(DDRC_ADDR_PPC + DXCCR, QSCNTEN_offset, QSCNTEN_mask, 1, regData);
        al9000_reg_update(DDRC_ADDR_PPC + DXCCR, regData, regDataNew);

    }

    regData = al9000_reg_read(DDRC_ADDR_PPC + OFFCAL_PR);
    if (env_cfg_ddr_mode == DDR3){
        regDataNew = al9000_field_set(DDRC_ADDR_PPC + OFFCAL_PR, dqs_pupd_en_offset, dqs_pupd_en_mask, 1, regData);
    }
    else {
        regDataNew = regData;
    }
    regDataNew = al9000_field_set(DDRC_ADDR_PPC + OFFCAL_PR, eye_rdbi_rpt_en_offset, eye_rdbi_rpt_en_mask, 1, regDataNew);
    al9000_reg_update(DDRC_ADDR_PPC + OFFCAL_PR, regData, regDataNew);

    regData = al9000_reg_read(DDRC_ADDR_PPC + DTCR0);
    regDataNew = al9000_field_set(DDRC_ADDR_PPC + DTCR0, DTRPTN_offset, DTRPTN_mask, 1, regData);
    al9000_reg_update(DDRC_ADDR_PPC + DTCR0, regData, regDataNew);
}
...
void do_training(u8 wl_en,u8 wl2_en,u8 gt_en)
{
    ...
    if (wl2_en == 0x1) {
        if (wl_en == 0x0)  {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, WLADJ_offset, WLADJ_mask, 1, regData);
        }
        if (wl_en == 0x1 ) {
            regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, WLADJ_offset, WLADJ_mask, 1, regDataNew);
        }
    }

    if (gt_en == 0x1)  {
        regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, QSGATE_offset, QSGATE_mask, 1, regData);
    }


    if ((wl2_en || wl_en || gt_en) == 1 ) {
        regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, INIT_offset, INIT_mask, 1, regDataNew);
        al9000_reg_update(DDRC_ADDR_PPC + PIR, regData, regDataNew);
    }
    ...
    if (wl2_en == 0x1 ) {
        al9000_field_wait(DDRC_ADDR_PPC + PGSR0, WLADONE_offset, WLADONE_mask, 1, 20);
    }
    ...
    if ((wl_en || wl2_en || gt_en ) == 1 ){
        al9000_field_wait(DDRC_ADDR_PPC + PIR, INIT_offset, INIT_mask, 0, 200);
    }
...
void eye_training()
{
    ...
    regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, RDEYE_offset, RDEYE_mask, 1, regDataNew);
    regDataNew = al9000_field_set(DDRC_ADDR_PPC + PIR, INIT_offset, INIT_mask, 1, regDataNew);
    al9000_reg_update(DDRC_ADDR_PPC + PIR, regData, regDataNew);

    al9000_field_wait(DDRC_ADDR_PPC + PGSR0, REDONE_offset, REDONE_mask, 1, 16);
    al9000_field_wait(DDRC_ADDR_PPC + PGSR0, WEDONE_offset, WEDONE_mask, 1, 16);
    al9000_field_wait(DDRC_ADDR_PPC + PIR, INIT_offset, INIT_mask, 0, 16);
...
void adjust_rddbi_level_result(u8 pub_index)
{
    ...
    for (int j = 0; j <= 3; j++) {
        //if (env_cfg_dx_en[j] == 1) {
            regData_1  = al9000_field_read(DDRC_ADDR_PPC + BDLR5[j], DMRBD_offset, DMRBD_mask);
            regData_2 = al9000_field_read(DDRC_ADDR_PPC + BDLR3[j], DQ0RBD_offset, DQ0RBD_mask);
            for(n = 0;n<=1000;n++){}
            al9000_field_write(DDRC_ADDR_PPC + BDLR3[j], DMRBD_offset, DMRBD_mask, regData_2);
            for (n = 0; n <= 1000; n++) {}
        //}
    }
...
>>>>>>> 1eaa58bd ([ES-382][style][fsbl]delete some comments, change al9000 to dr1x90 in fsbl/ddr code files):solutions/demo/fsbl/ddr/dr1x90_new_func.c
