...
_UL psio_data_0[] = {
    ...
    // Config CAN0_tx, PS IO 47->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_47.mc1_ensnk = 0x1E
    // 0xf880397c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880397c, 0x001f0000, 0x001e0000),
    ...
    // Config CAN0_rx, PS IO 46->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_46.mc1_ensnk = 0x1E
    // 0xf8803974[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803974, 0x001f0000, 0x001e0000),
    ...
    // Config ETH0_rx_clk, PS IO 22->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_22.mc1_ensnk = 0x17
    // 0xf88038b4[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038b4, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_rx_ctl, PS IO 27->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_27.mc1_ensnk = 0x17
    // 0xf88038dc[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038dc, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_rxd3, PS IO 26->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_26.mc1_ensnk = 0x17
    // 0xf88038d4[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038d4, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_rxd2, PS IO 25->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_25.mc1_ensnk = 0x17
    // 0xf88038cc[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038cc, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_rxd1, PS IO 24->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_24.mc1_ensnk = 0x17
    // 0xf88038c4[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038c4, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_rxd0, PS IO 23->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_23.mc1_ensnk = 0x17
    // 0xf88038bc[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038bc, 0x001f0000, 0x00170000),
    ...
    // Config ETH0_tx_clk, PS IO 16->PullType: high Z
    // register: PARA0_PS_MIO_16.PullType = 0xC
    // 0xf8803880[31:28] = 0xC
    CONFIG_REG_MASK(0xf8803880, 0xf0000000, 0xc0000000),
    ...
    // Config ETH0_tx_ctl, PS IO 21->PullType: high Z
    // register: PARA0_PS_MIO_21.PullType = 0xC
    // 0xf88038a8[31:28] = 0xC
    CONFIG_REG_MASK(0xf88038a8, 0xf0000000, 0xc0000000),
    ...
    // Config ETH0_txd3, PS IO 20->PullType: high Z
    // register: PARA0_PS_MIO_20.PullType = 0xC
    // 0xf88038a0[31:28] = 0xC
    CONFIG_REG_MASK(0xf88038a0, 0xf0000000, 0xc0000000),
    ...
    // Config ETH0_txd2, PS IO 19->PullType: high Z
    // register: PARA0_PS_MIO_19.PullType = 0xC
    // 0xf8803898[31:28] = 0xC
    CONFIG_REG_MASK(0xf8803898, 0xf0000000, 0xc0000000),
    ...
    // Config ETH0_txd1, PS IO 18->PullType: high Z
    // register: PARA0_PS_MIO_18.PullType = 0xC
    // 0xf8803890[31:28] = 0xC
    CONFIG_REG_MASK(0xf8803890, 0xf0000000, 0xc0000000),
    ...
    // Config ETH0_txd0, PS IO 17->PullType: high Z
    // register: PARA0_PS_MIO_17.PullType = 0xC
    // 0xf8803888[31:28] = 0xC
    CONFIG_REG_MASK(0xf8803888, 0xf0000000, 0xc0000000),
    ...
    // Config GPIO_PS_IO0, PS IO 0->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_0.mc1_ensnk = 0x1E
    // 0xf8803804[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803804, 0x001f0000, 0x001e0000),
    ...
    // Config GPIO_PS_IO7, PS IO 7->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_7.mc1_ensnk = 0x1E
    // 0xf880383c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880383c, 0x001f0000, 0x001e0000),
    ...
    // Config GPIO_PS_IO8, PS IO 8->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_8.mc1_ensnk = 0x1E
    // 0xf8803844[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803844, 0x001f0000, 0x001e0000),
    ...
    // Config GPIO_PS_IO9, PS IO 9->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_9.mc1_ensrc = 0x06
    // 0xf880384c[12:8] = 0x06
    CONFIG_REG_MASK(0xf880384c, 0x00001f00, 0x00000600),
    ...
    // Config GPIO_PS_IO9, PS IO 9->PullType: pullup 25k
    // register: PARA0_PS_MIO_9.PullType = 0x8
    // 0xf8803848[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803848, 0xf0000000, 0x80000000),
    ...
    // Config I2C0_scl, PS IO 50->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_50.mc1_ensnk = 0x1E
    // 0xf8803994[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803994, 0x001f0000, 0x001e0000),
    ...
    // Config I2C0_sda, PS IO 51->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_51.mc1_ensnk = 0x1E
    // 0xf880399c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880399c, 0x001f0000, 0x001e0000),
    ...
    // Config I2C1, Select IO: "PL IO", emio selection: mio, as a default value
    // register: EMIOSEL_1.emiosel_1 = 1
    // 0xF8803404[0:0] = 1
    CONFIG_REG_MASK(0xF8803404, 0x00000001, 0x00000001),

    // Config I2C1_Dot_IO, Select IO: "PL IO", emio selection: emio
    // register: EMIOSEL_1.emiosel_1 = 0x0
    // 0xF8803404[0:0] = 0x0
    CONFIG_REG_MASK(0xF8803404, 0x00000001, 0x00000000),
    ...
    // Config ETH0_mdc, PS IO 52->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_52.mc1_ensnk = 0x1E
    // 0xf88039a4[20:16] = 0x1E
    CONFIG_REG_MASK(0xf88039a4, 0x001f0000, 0x001e0000),
    ...
    // Config ETH0_mdio, PS IO 53->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_53.mc1_ensnk = 0x1E
    // 0xf88039ac[20:16] = 0x1E
    CONFIG_REG_MASK(0xf88039ac, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_ss0_n, PS IO 1->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_1.mc1_ensnk = 0x1E
    // 0xf880380c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880380c, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_clk, PS IO 6->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_6.mc1_ensnk = 0x1E
    // 0xf8803834[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803834, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_dq0, PS IO 2->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_2.mc1_ensnk = 0x1E
    // 0xf8803814[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803814, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_dq1, PS IO 3->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_3.mc1_ensnk = 0x1E
    // 0xf880381c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880381c, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_dq2, PS IO 4->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_4.mc1_ensnk = 0x1E
    // 0xf8803824[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803824, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_dq3, PS IO 5->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_5.mc1_ensnk = 0x1E
    // 0xf880382c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880382c, 0x001f0000, 0x001e0000),
    ...
    // Config qspi_ss0_n, PS IO 1->PullType: pullup 25k
    // register: PARA0_PS_MIO_1.PullType = 0x8
    // 0xf8803808[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803808, 0xf0000000, 0x80000000),
    ...
    // Config qspi_clk, PS IO 6->PullType: pullup 25k
    // register: PARA0_PS_MIO_6.PullType = 0x8
    // 0xf8803830[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803830, 0xf0000000, 0x80000000),
    ...
    // Config qspi_dq0, PS IO 2->PullType: pullup 25k
    // register: PARA0_PS_MIO_2.PullType = 0x8
    // 0xf8803810[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803810, 0xf0000000, 0x80000000),
    ...
    // Config qspi_dq1, PS IO 3->PullType: pullup 25k
    // register: PARA0_PS_MIO_3.PullType = 0x8
    // 0xf8803818[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803818, 0xf0000000, 0x80000000),
    ...
    // Config qspi_dq2, PS IO 4->PullType: pullup 25k
    // register: PARA0_PS_MIO_4.PullType = 0x8
    // 0xf8803820[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803820, 0xf0000000, 0x80000000),
    ...
    // Config qspi_dq3, PS IO 5->PullType: pullup 25k
    // register: PARA0_PS_MIO_5.PullType = 0x8
    // 0xf8803828[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803828, 0xf0000000, 0x80000000),
    ...
    // Config SD0_clk, PS IO 40->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_40.mc1_ensnk = 0x1E
    // 0xf8803944[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803944, 0x001f0000, 0x001e0000),
    ...
    // Config SD0_cmd, PS IO 41->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_41.mc1_ensnk = 0x1E
    // 0xf880394c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880394c, 0x001f0000, 0x001e0000),
    ...
    // Config SD0_d0, PS IO 42->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_42.mc1_ensnk = 0x1E
    // 0xf8803954[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803954, 0x001f0000, 0x001e0000),
    ...
    // Config SD0_d1, PS IO 43->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_43.mc1_ensnk = 0x1E
    // 0xf880395c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880395c, 0x001f0000, 0x001e0000),
    ...
    // Config SD0_d2, PS IO 44->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_44.mc1_ensnk = 0x1E
    // 0xf8803964[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803964, 0x001f0000, 0x001e0000),
    ...
    // Config SD0_d3, PS IO 45->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_45.mc1_ensnk = 0x1E
    // 0xf880396c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880396c, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_clk, PS IO 12->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_12.mc1_ensrc = 0x06
    // 0xf8803864[12:8] = 0x06
    CONFIG_REG_MASK(0xf8803864, 0x00001f00, 0x00000600),

    // Config SD1_clk, PS IO 12->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_12.mc1_ensnk = 0x1E
    // 0xf8803864[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803864, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_cmd, PS IO 11->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_11.mc1_ensrc = 0x06
    // 0xf880385c[12:8] = 0x06
    CONFIG_REG_MASK(0xf880385c, 0x00001f00, 0x00000600),

    // Config SD1_cmd, PS IO 11->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_11.mc1_ensnk = 0x1E
    // 0xf880385c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880385c, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_d0, PS IO 10->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_10.mc1_ensrc = 0x06
    // 0xf8803854[12:8] = 0x06
    CONFIG_REG_MASK(0xf8803854, 0x00001f00, 0x00000600),

    // Config SD1_d0, PS IO 10->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_10.mc1_ensnk = 0x1E
    // 0xf8803854[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803854, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_d1, PS IO 13->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_13.mc1_ensrc = 0x06
    // 0xf880386c[12:8] = 0x06
    CONFIG_REG_MASK(0xf880386c, 0x00001f00, 0x00000600),

    // Config SD1_d1, PS IO 13->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_13.mc1_ensnk = 0x1E
    // 0xf880386c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880386c, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_d2, PS IO 14->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_14.mc1_ensrc = 0x06
    // 0xf8803874[12:8] = 0x06
    CONFIG_REG_MASK(0xf8803874, 0x00001f00, 0x00000600),

    // Config SD1_d2, PS IO 14->Single-ended pull down Drive Strength: 8
    ...
    // Config SD1_d3, PS IO 15->Single-ended pull up Drive Strength: 8
    // register: PARA1_PS_MIO_15.mc1_ensrc = 0x06
    // 0xf880387c[12:8] = 0x06
    CONFIG_REG_MASK(0xf880387c, 0x00001f00, 0x00000600),

    // Config SD1_d3, PS IO 15->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_15.mc1_ensnk = 0x1E
    // 0xf880387c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880387c, 0x001f0000, 0x001e0000),
    ...
    // Config SD1_clk, PS IO 12->speed: fast
    // register: PARA0_PS_MIO_12.speed = 0x7
    // 0xf8803860[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803860, 0x00000007, 0x00000007),

    // Config SD1_clk, PS IO 12->PullType: pullup 25k
    // register: PARA0_PS_MIO_12.PullType = 0x8
    // 0xf8803860[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803860, 0xf0000000, 0x80000000),

    // Config SD1_cmd, PS IO 11->speed: fast
    // register: PARA0_PS_MIO_11.speed = 0x7
    // 0xf8803858[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803858, 0x00000007, 0x00000007),

    // Config SD1_cmd, PS IO 11->PullType: pullup 25k
    // register: PARA0_PS_MIO_11.PullType = 0x8
    // 0xf8803858[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803858, 0xf0000000, 0x80000000),

    // Config SD1_d0, PS IO 10->speed: fast
    // register: PARA0_PS_MIO_10.speed = 0x7
    // 0xf8803850[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803850, 0x00000007, 0x00000007),

    // Config SD1_d0, PS IO 10->PullType: pullup 25k
    // register: PARA0_PS_MIO_10.PullType = 0x8
    // 0xf8803850[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803850, 0xf0000000, 0x80000000),

    // Config SD1_d1, PS IO 13->speed: fast
    // register: PARA0_PS_MIO_13.speed = 0x7
    // 0xf8803868[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803868, 0x00000007, 0x00000007),

    // Config SD1_d1, PS IO 13->PullType: pullup 25k
    // register: PARA0_PS_MIO_13.PullType = 0x8
    // 0xf8803868[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803868, 0xf0000000, 0x80000000),

    // Config SD1_d2, PS IO 14->speed: fast
    // register: PARA0_PS_MIO_14.speed = 0x7
    // 0xf8803870[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803870, 0x00000007, 0x00000007),

    // Config SD1_d2, PS IO 14->PullType: pullup 25k
    // register: PARA0_PS_MIO_14.PullType = 0x8
    // 0xf8803870[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803870, 0xf0000000, 0x80000000),

    // Config SD1_d3, PS IO 15->speed: fast
    // register: PARA0_PS_MIO_15.speed = 0x7
    // 0xf8803878[2:0] = 0x7
    CONFIG_REG_MASK(0xf8803878, 0x00000007, 0x00000007),

    // Config SD1_d3, PS IO 15->PullType: pullup 25k
    // register: PARA0_PS_MIO_15.PullType = 0x8
    // 0xf8803878[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803878, 0xf0000000, 0x80000000),

    // Config SD1, PS IO 12->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_12.funcsel_ps_mio_12 = 10
    // 0xf8803030[3:0] = 10
    CONFIG_REG_MASK(0xf8803030, 0x0000000f, 0x0000000a),

    // Config SD1, PS IO 11->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_11.funcsel_ps_mio_11 = 10
    // 0xf880302c[3:0] = 10
    CONFIG_REG_MASK(0xf880302c, 0x0000000f, 0x0000000a),

    // Config SD1, PS IO 10->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_10.funcsel_ps_mio_10 = 10
    // 0xf8803028[3:0] = 10
    CONFIG_REG_MASK(0xf8803028, 0x0000000f, 0x0000000a),

    // Config SD1, PS IO 13->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_13.funcsel_ps_mio_13 = 10
    // 0xf8803034[3:0] = 10
    CONFIG_REG_MASK(0xf8803034, 0x0000000f, 0x0000000a),

    // Config SD1, PS IO 14->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_14.funcsel_ps_mio_14 = 10
    // 0xf8803038[3:0] = 10
    CONFIG_REG_MASK(0xf8803038, 0x0000000f, 0x0000000a),

    // Config SD1, PS IO 15->FUNCSEL: SD1
    // register: FUNCSEL_PS_MIO_15.funcsel_ps_mio_15 = 10
    // 0xf880303c[3:0] = 10
    CONFIG_REG_MASK(0xf880303c, 0x0000000f, 0x0000000a),

    // Config SD1, Select IO: "PS IO 10...15", emio selection: mio, as a default value
    // register: EMIOSEL_12.emiosel_12 = 1
    // 0xF8803430[0:0] = 1
    CONFIG_REG_MASK(0xF8803430, 0x00000001, 0x00000001),
    ...
    // Config UART1_tx, PS IO 48->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_48.mc1_ensnk = 0x1E
    // 0xf8803984[20:16] = 0x1E
    CONFIG_REG_MASK(0xf8803984, 0x001f0000, 0x001e0000),
    ...
    // Config UART1_rx, PS IO 49->Single-ended pull down Drive Strength: 8
    // register: PARA1_PS_MIO_49.mc1_ensnk = 0x1E
    // 0xf880398c[20:16] = 0x1E
    CONFIG_REG_MASK(0xf880398c, 0x001f0000, 0x001e0000),
    ...
    // Config USB0_stp, PS IO 30->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_30.mc1_ensnk = 0x17
    // 0xf88038f4[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038f4, 0x001f0000, 0x00170000),
    ...
    // Config USB0_dir, PS IO 29->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_29.mc1_ensnk = 0x17
    // 0xf88038ec[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038ec, 0x001f0000, 0x00170000),
    ...
    // Config USB0_nxt, PS IO 31->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_31.mc1_ensnk = 0x17
    // 0xf88038fc[20:16] = 0x17
    CONFIG_REG_MASK(0xf88038fc, 0x001f0000, 0x00170000),
    ...
    // Config USB0_clk, PS IO 36->Single-ended pull down Drive Strength: 16
    // register: PARA1_PS_MIO_36.mc1_ensnk = 0x17
    // 0xf8803924[20:16] = 0x17
    CONFIG_REG_MASK(0xf8803924, 0x001f0000, 0x00170000),
    ...
    // Config USB0_d7, PS IO 39->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_39.mc1_ensrc = 0x15
    // 0xf880393c[12:8] = 0x15
    CONFIG_REG_MASK(0xf880393c, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d6, PS IO 38->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_38.mc1_ensrc = 0x15
    // 0xf8803934[12:8] = 0x15
    CONFIG_REG_MASK(0xf8803934, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d5, PS IO 37->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_37.mc1_ensrc = 0x15
    // 0xf880392c[12:8] = 0x15
    CONFIG_REG_MASK(0xf880392c, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d4, PS IO 28->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_28.mc1_ensrc = 0x15
    // 0xf88038e4[12:8] = 0x15
    CONFIG_REG_MASK(0xf88038e4, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d3, PS IO 35->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_35.mc1_ensrc = 0x15
    // 0xf880391c[12:8] = 0x15
    CONFIG_REG_MASK(0xf880391c, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d2, PS IO 34->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_34.mc1_ensrc = 0x15
    // 0xf8803914[12:8] = 0x15
    CONFIG_REG_MASK(0xf8803914, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d1, PS IO 33->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_33.mc1_ensrc = 0x15
    // 0xf880390c[12:8] = 0x15
    CONFIG_REG_MASK(0xf880390c, 0x00001f00, 0x00001500),
    ...
    // Config USB0_d0, PS IO 32->Single-ended pull up Drive Strength: 16
    // register: PARA1_PS_MIO_32.mc1_ensrc = 0x15
    // 0xf8803904[12:8] = 0x15
    CONFIG_REG_MASK(0xf8803904, 0x00001f00, 0x00001500),
...
_UL clk_data_0[] = {
    ...
    // Config SDIO IP Clock, system div para for sdio:1, clock source: IO_400
    // register: IO1000_CNT_DIV.div_sdio = 0x00000000
    // 0xF8801030[29:24] = 0x00000000
    CONFIG_REG_MASK(0xF8801030, 0x3f000000, 0x00000000),
...
_UL system_data_0[] = {
    ...
    CONFIG_REG_MASK(0xF8800030, 0x3f000000, 0x02000000),

    // Config NPU, status: Disable
    // register: CFG_CTRL_NPU.ctrl_npu = 0x0
    // 0xF88001BC[1:0] = 0x0
    CONFIG_REG_MASK(0xF88001BC, 0x00000003, 0x00000000),
...
/* only config psio, ps-pl,peripheral when using amp */
int __Soc_PlatInit_AMP() 
{
    int rtn = 0;
    _UL *config_data;
...
int Soc_PlatInit() {
#ifndef HAVE_OPENAMP
    return __Soc_PlatInit();
#else 
    return __Soc_PlatInit_AMP();
#endif
}
