...
/* (1)psio data */
_UL psio_data_0[] = {
    // Config CAN0_tx, PS IO 51->Single-ended pull up Drive Strength: 8
    ...
    // Config CAN0_rx, PS IO 50->Single-ended pull up Drive Strength: 8
    ...
    // Config CAN0_tx, PS IO 51->speed: slow
    // register: PARA0_PS_MIO_51.speed = 0x0
    // 0xf8803998[2:0] = 0x0
    CONFIG_REG_MASK(0xf8803998, 0x00000007, 0x00000000),

    // Config CAN0_tx, PS IO 51->PullType: pullup 25k
    // register: PARA0_PS_MIO_51.PullType = 0x8
    // 0xf8803998[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803998, 0xf0000000, 0x80000000),

    // Config CAN0_rx, PS IO 50->speed: slow
    // register: PARA0_PS_MIO_50.speed = 0x0
    // 0xf8803990[2:0] = 0x0
    CONFIG_REG_MASK(0xf8803990, 0x00000007, 0x00000000),

    // Config CAN0_rx, PS IO 50->PullType: pullup 25k
    // register: PARA0_PS_MIO_50.PullType = 0x8
    // 0xf8803990[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803990, 0xf0000000, 0x80000000),

    // Config CAN0, PS IO 51->FUNCSEL: CAN0
    // register: FUNCSEL_PS_MIO_51.funcsel_ps_mio_51 = 1
    // 0xf88030cc[3:0] = 1
    CONFIG_REG_MASK(0xf88030cc, 0x0000000f, 0x00000001),

    // Config CAN0, PS IO 50->FUNCSEL: CAN0
    // register: FUNCSEL_PS_MIO_50.funcsel_ps_mio_50 = 1
    // 0xf88030c8[3:0] = 1
    CONFIG_REG_MASK(0xf88030c8, 0x0000000f, 0x00000001),

    // Config CAN0, Select IO: "PS IO 50...51", config emio
    ...
    // Config I2C0_scl, PS IO 46->Single-ended pull up Drive Strength: 8
    ...
    // Config I2C0_sda, PS IO 47->Single-ended pull up Drive Strength: 8
    ...
    // Config I2C0_scl, PS IO 46->speed: slow
    // register: PARA0_PS_MIO_46.speed = 0x0
    // 0xf8803970[2:0] = 0x0
    CONFIG_REG_MASK(0xf8803970, 0x00000007, 0x00000000),

    // Config I2C0_scl, PS IO 46->PullType: pullup 25k
    // register: PARA0_PS_MIO_46.PullType = 0x8
    // 0xf8803970[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803970, 0xf0000000, 0x80000000),

    // Config I2C0_sda, PS IO 47->speed: slow
    // register: PARA0_PS_MIO_47.speed = 0x0
    // 0xf8803978[2:0] = 0x0
    CONFIG_REG_MASK(0xf8803978, 0x00000007, 0x00000000),

    // Config I2C0_sda, PS IO 47->PullType: pullup 25k
    // register: PARA0_PS_MIO_47.PullType = 0x8
    // 0xf8803978[31:28] = 0x8
    CONFIG_REG_MASK(0xf8803978, 0xf0000000, 0x80000000),

    // Config I2C0, PS IO 46->FUNCSEL: I2C0
    // register: FUNCSEL_PS_MIO_46.funcsel_ps_mio_46 = 0
    // 0xf88030b8[3:0] = 0
    CONFIG_REG_MASK(0xf88030b8, 0x0000000f, 0x00000000),

    // Config I2C0, PS IO 47->FUNCSEL: I2C0
    // register: FUNCSEL_PS_MIO_47.funcsel_ps_mio_47 = 0
    // 0xf88030bc[3:0] = 0
    CONFIG_REG_MASK(0xf88030bc, 0x0000000f, 0x00000000),

    // Config I2C0, Select IO: "PS IO 46...47", config emio
    ...
    // Config SD0, Select IO: "PS IO 40...45", config emio
...
_UL peripherals_data_0[] = {
    ...
    // Config SD0, Set CARD_DETECT
    // register: CFG_CTRL_SDIO0.CFG_CARD_DETECT_N = 0x0
    // 0xF8800150[4:4] = 0x0
    CONFIG_REG_MASK(0xF8800150, 0x00000010, 0x00000000),

    // Config SD0, Set CARD_WRITE_PROT
    // register: CFG_CTRL_SDIO0.CFG_CARD_WRITE_PROT = 0x0
    // 0xF8800150[5:5] = 0x0
    CONFIG_REG_MASK(0xF8800150, 0x00000020, 0x00000000),
    ...
    // Config UART1, Data Terminal Ready:0x1
    // register: MCR.DTR = 1
    // 0xF8401010[0:0] = 1
    CONFIG_REG_MASK(0xF8401010, 0x00000001, 0x00000001),

    // Config UART1, Request to Send:0x1
    // register: MCR.RTS = 1
    // 0xF8401010[1:1] = 1
    CONFIG_REG_MASK(0xF8401010, 0x00000002, 0x00000002),
